      ...
      <div className="relative bg-white rounded-3xl max-w-3xl w-full shadow-2xl overflow-hidden border border-slate-200 flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 bg-indigo-950 text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-indigo-500/30 border border-indigo-400/30 rounded-2xl">
              <ShieldAlert className="w-5 h-5 text-indigo-300" />
            </div>
            <div>
              <h2 className="text-xl font-black tracking-tight">Restaurant Management Hub</h2>
              <p className="text-xs text-indigo-300">Oversee live orders and manage kitchen dishes</p>
            </div>
          </div>
        ...
        {statusMessage && (
          <div className="bg-emerald-500 text-white px-6 py-2 text-xs font-semibold flex items-center gap-2">
                    ...
                    <div key={item.id} className="py-2.5 flex items-center justify-between text-xs">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-slate-500">${item.price.toFixed(2)} • {item.category}</span>
                        </div>
                      </div>
